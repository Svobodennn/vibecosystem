...
139 agents. 285 skills. 66 hooks. Ноль ручной работы.
...
Существует 63 хука, но они не запускаются все одновременно. Намерение определяет, какие хуки срабатывают.
