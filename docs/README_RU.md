...
139 agents. 283 skills. 60 hooks. Ноль ручной работы.
...
Существует 60 хуков, но они не запускаются все одновременно. Намерение определяет, какие хуки срабатывают.
