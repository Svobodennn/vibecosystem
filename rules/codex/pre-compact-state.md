...
1. Aktif plan varsa `update_plan` ile tamamlanan ve kalan adimlari guncelle
2. Kalici proje notu gerekiyorsa kullanicinin onayli proje notepad/AGENTS.md yolunu kullan; Codex memory SQLite dosyasina dogrudan yazma
3. Kurulu roster'da uygun bir continuity rolu varsa kullan; yoksa state dump'ini parent context'te yap
