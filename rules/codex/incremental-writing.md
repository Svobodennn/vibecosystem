...
```
1. Section 1'i yaz → apply_patch ile dosyaya kaydet
2. Section 2'yi yaz → apply_patch ile dosyaya ekle
3. Section 3'u yaz → apply_patch ile dosyaya ekle
4. ...
```
...
- apply_patch'i her bolumden sonra cagir
- Kurulu roster'daki dokumantasyon rolleri bu pattern'i kullanmali
- Buyuk refactoring yapan roller de ayni pattern'i uygulayabilir; rol kullanmadan once `~/.codex/agents/*.toml` envanterini kontrol et
