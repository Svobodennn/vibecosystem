...
3. PR govdesi = SADECE "What & why" (kisa, human). Test-plan/boilerplate YOK, "Generated with AI" YOK.
...
Security sorunu bulunursa: DURDUR. `~/.codex/agents/*.toml` icinde uygun guvenlik rolu varsa `spawn_agent` ile cagir; yoksa parent context'te incele. CRITICAL bulguyu duzelt ve sizmis secret varsa kullanicidan rotation iste.
...
Kurulu roster'da uygun test rolu varsa kullan; yoksa testleri parent context'te yurut. Yalniz `~/.codex/agents/*.toml` icinde tanimli rolleri cagir.
