...
Hook payload semasi bu ortamda dogrulanmadikca otomatik enforcement aktif sayilmaz. `~/.codex/hooks.json` icinde trusted bir `epistemic-reminder` handler'i yoksa bu proseduru manuel uygula.
