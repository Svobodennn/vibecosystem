...
## request_user_input Kullanim Rehberi
...
Kurulu agent roster'ini `~/.codex/agents/*.toml` altindan oku. Yalniz orada tanimli bir rol karar noktasina sahipse bu pattern'i o role uygula; roster bos veya uygun rol yoksa karari parent context'te yurut.
