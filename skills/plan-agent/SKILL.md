...
4. **Codebase map** (brownfield only) - Pre-generated by scout/harvest if this is an existing codebase
...
| Task | Ana Agent | Yedek | QA Agent(s) | Parallel With |
|------|-----------|-------|-------------|---------------|
...
## Task Overview
1. [Task 1 name] - [Brief description] - Agent: [ana-agent] → QA: [qa-agent]
2. [Task 2 name] - [Brief description] - Agent: [ana-agent] → QA: [qa-agent]
3. [Task 3 name] - [Brief description] - Agent: [ana-agent] → QA: [qa-agent]
[...]
...
- [ ] Agent Roster table + per-task `Agents:` line (matrix-compliant, names verified in `~/.claude/agents/`)
